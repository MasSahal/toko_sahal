                ...
                <div class="p-5">
                  ...
                  <?php
                    ...
                    if (isset($_POST['login'])) {
                      ...
                      if ($cek == 1) {
                        ...
                        echo "<meta http-equiv='refresh' content='0;url=index.php?halaman=dashboard'>";
                  ...
                  <form class="" method="post">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Username" name="user">
                    </div>
                    <div class="form-group">
